...
# Template: subdirs
# Command: /usr/lib/qt5/bin/qmake -o Makefile valkyrie.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = valkyrie2.0.0
DISTDIR = /home/vdumas/Downloads/valgrind/valkyrie-2.0.0/.tmp/valkyrie2.0.0
SUBTARGETS    =  \
		sub-src
...
sub-src-qmake_all:  FORCE
	...
	cd src/ && $(QMAKE) -o Makefile /home/vdumas/Downloads/valgrind/valkyrie-2.0.0/src/src.pro
	cd src/ && $(MAKE) -f Makefile qmake_all
sub-src: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/vdumas/Downloads/valgrind/valkyrie-2.0.0/src/src.pro ) && $(MAKE) -f Makefile
sub-src-make_first: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/vdumas/Downloads/valgrind/valkyrie-2.0.0/src/src.pro ) && $(MAKE) -f Makefile 
sub-src-all: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/vdumas/Downloads/valgrind/valkyrie-2.0.0/src/src.pro ) && $(MAKE) -f Makefile all
sub-src-clean: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/vdumas/Downloads/valgrind/valkyrie-2.0.0/src/src.pro ) && $(MAKE) -f Makefile clean
sub-src-distclean: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/vdumas/Downloads/valgrind/valkyrie-2.0.0/src/src.pro ) && $(MAKE) -f Makefile distclean
sub-src-install_subtargets: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/vdumas/Downloads/valgrind/valkyrie-2.0.0/src/src.pro ) && $(MAKE) -f Makefile install
sub-src-uninstall_subtargets: FORCE
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/vdumas/Downloads/valgrind/valkyrie-2.0.0/src/src.pro ) && $(MAKE) -f Makefile uninstall

Makefile: valkyrie.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
...
sub-src-check:
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/vdumas/Downloads/valgrind/valkyrie-2.0.0/src/src.pro ) && $(MAKE) -f Makefile check
check: sub-src-check

sub-src-benchmark:
	@test -d src/ || mkdir -p src/
	cd src/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/vdumas/Downloads/valgrind/valkyrie-2.0.0/src/src.pro ) && $(MAKE) -f Makefile benchmark
